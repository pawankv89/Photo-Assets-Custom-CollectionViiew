...
//  PKPhotoAssetsCustom
//
//  Created by Pawan kumar on 12/4/17.
...
@interface ViewController ()<UICollectionViewDelegate, UICollectionViewDataSource,PKDropDownDelegate>

@property(strong, nonatomic) IBOutlet UICollectionView *collectionView;
@property (nonatomic, weak) IBOutlet PKDropDown *dropdown;
@property (strong) PHFetchResult *photos;
